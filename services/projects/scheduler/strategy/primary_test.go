...
func TestAlwaysPrimaryScheduler(t *testing.T) {
	t.Parallel()

	t.Run("returns the primary cell when one exists", func(t *testing.T) {
		...
		scheduler := strategy.AlwaysPrimary{}
	...
	t.Run("returns error when no primary cell exists", func(t *testing.T) {
		ctx := context.Background()
