	...
	tests := []struct {
	...
	}{
		{
			...
			client: &mockClusterClient{
				...
				patchBranchHibernationFunc: func(ctx context.Context, branch *v1alpha1.Branch) error {
					return errors.New("patchBranchHibernationFunc should not be called")
				},
			},
			wantErr: nil,
		},
		{
			name: "no branch, cluster is healthy, nil annotations, should hibernate and suspend scheduled backup",
			client: &mockClusterClient{
				getClusterFunc: func(ctx context.Context, forceUpdate bool) (*cnpgv1.Cluster, error) {
					return &cnpgv1.Cluster{
						Status: cnpgv1.ClusterStatus{
		...
		{
			name: "no branch, cluster is healthy, annotation succeeds",
			client: &mockClusterClient{
				getClusterFunc: func(ctx context.Context, forceUpdate bool) (*cnpgv1.Cluster, error) {
					return &cnpgv1.Cluster{
						Status: cnpgv1.ClusterStatus{
		...
		{
			name: "no branch, cluster is healthy, updateCluster returns error",
			client: &mockClusterClient{
				getClusterFunc: func(ctx context.Context, forceUpdate bool) (*cnpgv1.Cluster, error) {
					return &cnpgv1.Cluster{
						Status: cnpgv1.ClusterStatus{
		...
		{
			name: "no branch, cluster is healthy, getClusterScheduledBackup returns not found error - no error returned",
			client: &mockClusterClient{
				getClusterFunc: func(ctx context.Context, forceUpdate bool) (*cnpgv1.Cluster, error) {
					return &cnpgv1.Cluster{
						Status: cnpgv1.ClusterStatus{
		...
		{
			name: "no branch, cluster is healthy, getClusterScheduledBackup returns error - error is returned",
			client: &mockClusterClient{
				getClusterFunc: func(ctx context.Context, forceUpdate bool) (*cnpgv1.Cluster, error) {
					return &cnpgv1.Cluster{
						Status: cnpgv1.ClusterStatus{
		...
		{
			name: "branch exists, cluster is healthy - branch should be hibnernated",
			client: &mockClusterClient{
				getClusterFunc: func(ctx context.Context, forceUpdate bool) (*cnpgv1.Cluster, error) {
					return &cnpgv1.Cluster{
						Status: cnpgv1.ClusterStatus{
		...
		{
			name: "branch exists with wakeup-pool annotation, cluster is healthy - cluster name should be removed",
			client: &mockClusterClient{
				getClusterFunc: func(ctx context.Context, forceUpdate bool) (*cnpgv1.Cluster, error) {
					return &cnpgv1.Cluster{
						Status: cnpgv1.ClusterStatus{
				...
				patchBranchHibernationFunc: func(ctx context.Context, branch *v1alpha1.Branch) error {
					require.Fail(t, "patchBranchHibernation should not be called for pool hibernation")
					return nil
				},
				patchBranchClusterNameFunc: func(ctx context.Context, branch *v1alpha1.Branch) error {
					// return the test error to verify that this function is called
					return errTest
				},
			},
			wantErr: errTest,
		...
		{
			name: "branch exists, cluster is healthy, updateBranch returns error - error is returned",
			client: &mockClusterClient{
				getClusterFunc: func(ctx context.Context, forceUpdate bool) (*cnpgv1.Cluster, error) {
					return &cnpgv1.Cluster{
						Status: cnpgv1.ClusterStatus{
