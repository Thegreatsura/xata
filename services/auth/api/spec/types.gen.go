...
// Valid indicates whether the value is a known member of the BillingCreditStatus enum.
func (e BillingCreditStatus) Valid() bool {
	switch e {
	case Active:
		return true
	case PendingPayment:
...
// Valid indicates whether the value is a known member of the MarketplaceRegistrationProvider enum.
func (e MarketplaceRegistrationProvider) Valid() bool {
	switch e {
	case MarketplaceRegistrationProviderAWS:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the OrganizationMarketplaceProvider enum.
func (e OrganizationMarketplaceProvider) Valid() bool {
	switch e {
...
// Valid indicates whether the value is a known member of the OrganizationStatusBillingStatus enum.
func (e OrganizationStatusBillingStatus) Valid() bool {
	switch e {
...
// Valid indicates whether the value is a known member of the OrganizationStatusStatus enum.
func (e OrganizationStatusStatus) Valid() bool {
	switch e {
	case Disabled:
		return true
	case Enabled:
...
// Valid indicates whether the value is a known member of the OrganizationStatusUsageTier enum.
func (e OrganizationStatusUsageTier) Valid() bool {
	switch e {
	case T1:
		return true
	case T2:
...
// Valid indicates whether the value is a known member of the ListOrganizationInvitationsParamsStatus enum.
func (e ListOrganizationInvitationsParamsStatus) Valid() bool {
	switch e {
	case ListOrganizationInvitationsParamsStatusExpired:
		return true
	case ListOrganizationInvitationsParamsStatusPending:
		return true
	default:
		return false
	}
...
type Organization struct {
	...
	// Marketplace Marketplace provider for this organization (e.g. "aws"), if billed through a marketplace
	Marketplace *OrganizationMarketplaceProvider `json:"marketplace,omitempty"`
