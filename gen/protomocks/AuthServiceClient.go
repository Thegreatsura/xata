...
func (_m *AuthServiceClient) GetGithubIdentityProviderToken(ctx context.Context, in *authv1.GetGithubIdentityProviderTokenRequest, opts ...grpc.CallOption) (*authv1.GetGithubIdentityProviderTokenResponse, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetGithubIdentityProviderToken")
	}

	var r0 *authv1.GetGithubIdentityProviderTokenResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *authv1.GetGithubIdentityProviderTokenRequest, ...grpc.CallOption) (*authv1.GetGithubIdentityProviderTokenResponse, error)); ok {
...
func (_c *AuthServiceClient_GetGithubIdentityProviderToken_Call) RunAndReturn(run func(context.Context, *authv1.GetGithubIdentityProviderTokenRequest, ...grpc.CallOption) (*authv1.GetGithubIdentityProviderTokenResponse, error)) *AuthServiceClient_GetGithubIdentityProviderToken_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *AuthServiceClient) GetOrganization(ctx context.Context, in *authv1.GetOrganizationRequest, opts ...grpc.CallOption) (*authv1.GetOrganizationResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *authv1.GetOrganizationRequest, ...grpc.CallOption) (*authv1.GetOrganizationResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
...
func (_c *AuthServiceClient_GetOrganization_Call) RunAndReturn(run func(context.Context, *authv1.GetOrganizationRequest, ...grpc.CallOption) (*authv1.GetOrganizationResponse, error)) *AuthServiceClient_GetOrganization_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *AuthServiceClient) ResolveVercelInstallation(ctx context.Context, in *authv1.ResolveVercelInstallationRequest, opts ...grpc.CallOption) (*authv1.ResolveVercelInstallationResponse, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for ResolveVercelInstallation")
	}

	var r0 *authv1.ResolveVercelInstallationResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *authv1.ResolveVercelInstallationRequest, ...grpc.CallOption) (*authv1.ResolveVercelInstallationResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
...
func (_c *AuthServiceClient_ResolveVercelInstallation_Call) RunAndReturn(run func(context.Context, *authv1.ResolveVercelInstallationRequest, ...grpc.CallOption) (*authv1.ResolveVercelInstallationResponse, error)) *AuthServiceClient_ResolveVercelInstallation_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *AuthServiceClient) UpdateOrganization(ctx context.Context, in *authv1.UpdateOrganizationRequest, opts ...grpc.CallOption) (*authv1.UpdateOrganizationResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *authv1.UpdateOrganizationRequest, ...grpc.CallOption) (*authv1.UpdateOrganizationResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
...
func (_c *AuthServiceClient_UpdateOrganization_Call) RunAndReturn(run func(context.Context, *authv1.UpdateOrganizationRequest, ...grpc.CallOption) (*authv1.UpdateOrganizationResponse, error)) *AuthServiceClient_UpdateOrganization_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *AuthServiceClient) ValidateAccess(ctx context.Context, in *authv1.ValidateAccessRequest, opts ...grpc.CallOption) (*authv1.ValidateAccessResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *authv1.ValidateAccessRequest, ...grpc.CallOption) (*authv1.ValidateAccessResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
...
func (_c *AuthServiceClient_ValidateAccess_Call) RunAndReturn(run func(context.Context, *authv1.ValidateAccessRequest, ...grpc.CallOption) (*authv1.ValidateAccessResponse, error)) *AuthServiceClient_ValidateAccess_Call {
	_c.Call.Return(run)
	return _c
}
